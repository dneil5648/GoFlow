...
func contextFlow(client *openai.OpenAIClient, sysMessage string, uMessage string, fields []components.SchemaField, variables map[string]interface{}) (interface{}, error){
    schemaFields := fields
